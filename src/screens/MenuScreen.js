...
const MenuScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView className="m-1 bg-white flex-1 ">
      <TouchableOpacity
        className=" mt-5 ml-2 mr-2 rounded-lg bg-amber-500 h-12 w-auto justify-center"
      ...
      <TouchableOpacity className=" mt-3 ml-2 mr-2 rounded-lg bg-amber-500 h-12 w-auto justify-center"
      ...
      <TouchableOpacity
        className=" mt-3 ml-2 mr-2 rounded-lg bg-amber-500 h-12 w-auto justify-center "
